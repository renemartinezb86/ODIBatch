...
public class EquiposController {
    ...
    public String eocOrderToEquiposPre() {
        try {
            ...
            //propFileName = "D:\\Work\\ODI\\conf\\equipos.properties";
        ...
        try {
            ...
            String header =
                "Código de la Venta;Código del Contrato;Codigo Sucursal;RUT/RUC Código del Personal;Código del Cliente;Nombre del Cliente;Ciudad de Domicílio del Cliente;MSISDN;IMEI;Fecha de la Venta;Product Offer";
            writeLine(header);
